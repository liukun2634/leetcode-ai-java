...
### 面试官常见 follow-up
1. **"N 皇后 II（[LC 52](https://leetcode.cn/problems/n-queens-ii/)，只求数量）？"** → 同思路，count++ 替代构造解。
...
### 同类型推荐（**回溯剪枝家族**）
- [LC 52. N 皇后 II](https://leetcode.cn/problems/n-queens-ii/)（计数）
- LC 37. 解数独（多重剪枝）
- [LC 22. 括号生成](https://leetcode.cn/problems/generate-parentheses/)
- [LC 79. 单词搜索](https://leetcode.cn/problems/word-search/)
- [LC 212. 单词搜索 II](https://leetcode.cn/problems/word-search-ii/)（Trie + 回溯）
