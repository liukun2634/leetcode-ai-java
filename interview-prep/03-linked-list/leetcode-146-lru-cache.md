...
### 面试官常见 follow-up
1. **"改成 LFU（最不常使用）？"** → 需要另加“频次桶”映射到双向链表，难度跳一级。即 [**LC 460**](https://leetcode.cn/problems/lfu-cache/)。
...
### 同类型推荐（**设计题 + 双向链表家族**）
- [LC 460. LFU 缓存](https://leetcode.cn/problems/lfu-cache/)（频率桶 + 双向链表，🔴）
- LC 432. 全 O(1) 数据结构
- [LC 380. 常数时间插入、删除和获取随机元素](https://leetcode.cn/problems/insert-delete-getrandom-o1/)（哈希 + 数组）
- [LC 295. 数据流的中位数](https://leetcode.cn/problems/find-median-from-data-stream/)（双堆）
- [LC 155. 最小栈](https://leetcode.cn/problems/min-stack/)（辅助栈）
- [LC 706. 设计哈希映射](https://leetcode.cn/problems/design-hashmap/)（自己实现 HashMap）
