...
### 面试官常见 follow-up
1. **"反转链表的区间 [m, n]？"** → [LC 92](https://leetcode.cn/problems/reverse-linked-list-ii/)，dummy + 定位 + 本模板 + 接回。
2. **"K 个一组反转链表？"** → [LC 25](https://leetcode.cn/problems/reverse-nodes-in-k-group/)，递归套迭代；或迭代中先走 k 步计数、不够则不反转。
3. **"两两交换节点？"** → [LC 24](https://leetcode.cn/problems/swap-nodes-in-pairs/)，dummy + 递归最简；迭代需争取表达清晰。
4. **"判是不是回文链表？"** → [LC 234](https://leetcode.cn/problems/palindrome-linked-list/)，快慢指针找中点 + 后半本模板反转 + 两走比较。
...
- [LC 25. K 个一组翻转链表](https://leetcode.cn/problems/reverse-nodes-in-k-group/)（递归套迭代）
- [LC 24. 两两交换链表中的节点](https://leetcode.cn/problems/swap-nodes-in-pairs/)
- [LC 21. 合并两个有序链表](https://leetcode.cn/problems/merge-two-sorted-lists/)（dummy 头模板）
- [LC 141](https://leetcode.cn/problems/linked-list-cycle/) / 142. 环形链表（快慢指针）
- [LC 160. 相交链表](https://leetcode.cn/problems/intersection-of-two-linked-lists/)（双指针消除长度差）
- [LC 234. 回文链表](https://leetcode.cn/problems/palindrome-linked-list/)（找中点 + 反转后半 + 比较）
