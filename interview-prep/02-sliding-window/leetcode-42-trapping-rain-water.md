...
### 面试官常见 follow-up
1. **"盛最多水的容器（LC 11）和本题区别在哪？"** → LC 11 只需选两根柱形成水桶，双指针总是移动较矮者；本题考虑每个位置都会藏水。
2. **"二维接雨水怎么做？"** → 最小堆 + BFS，从外圈向内扩。即 **LC 407**。
...
### 同类型推荐
- LC 11. 盛最多水的容器（双指针的"姊妹"题，更易上手）
- LC 84. 柱状图中最大的矩形（单调栈天花板）
- LC 407. 接雨水 II（二维 + 堆）
- LC 238. 除自身以外数组的乘积（前后缀思想）
- LC 845. 数组中的最长山脉
- LC 1793. 好子数组的最大分数
