...
### 面试官常见 follow-up
1. **"滑动窗口中位数？"** → 双堆 + 延迟删除；或 TreeMap 多重集。即 [**LC 480**](https://leetcode.cn/problems/sliding-window-median/)。
2. **"只要求第 k 大项（k 固定）？"** → 单堆即可：小顶堆保持 size = k。即 [**LC 703**](https://leetcode.cn/problems/kth-largest-element-in-a-stream/)。
...
### 同类型推荐（**堆设计家族**）
- [LC 480. 滑动窗口中位数](https://leetcode.cn/problems/sliding-window-median/)（**双堆 + 延迟删除**，🔴）
- [LC 703. 数据流中的第 K 大元素](https://leetcode.cn/problems/kth-largest-element-in-a-stream/)（单堆）
- [LC 215. 数组中的第 K 个最大元素](https://leetcode.cn/problems/kth-largest-element-in-an-array/)
- [LC 23. 合并 K 个升序链表](https://leetcode.cn/problems/merge-k-sorted-lists/)（小顶堆）
