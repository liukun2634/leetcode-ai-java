...
### 面试官常见 follow-up
1. **"支持通配符 . 的 search（[LC 211](https://leetcode.cn/problems/design-add-and-search-words-data-structure/)）？"** → 遇到 . 时递归尝试所有 26 个孩子。
2. **"单词搜索 II（[LC 212](https://leetcode.cn/problems/word-search-ii/)）？"** → Trie + DFS 在棋盘上回溯。
...
### 同类型推荐（**Trie 家族**）
- [LC 211. 添加与搜索单词](https://leetcode.cn/problems/design-add-and-search-words-data-structure/)（含 . 通配符）
- [LC 212. 单词搜索 II](https://leetcode.cn/problems/word-search-ii/)（Trie + DFS）
- LC 14. 最长公共前缀
- LC 720. 词典中最长的单词
- [LC 648. 单词替换](https://leetcode.cn/problems/replace-words/)
- [LC 421. 数组中两个数的最大异或值](https://leetcode.cn/problems/maximum-xor-of-two-numbers-in-an-array/)（**Trie 位树**）
- [LC 1268. 搜索推荐系统](https://leetcode.cn/problems/search-suggestions-system/)
