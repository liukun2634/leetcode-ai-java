...
### 面试官常见 follow-up
1. **"求凑出 amount 的方案数（[LC 518](https://leetcode.cn/problems/coin-change-ii/)）？"** → 外硬币内金额，`dp[i] += dp[i-c]`。顺序不能颗倒。
2. **"求本身是完全平方数的最少个数（[LC 279](https://leetcode.cn/problems/perfect-squares/)）？"** → 完全背包，硬币面额是 1²,2²,3²,…
...
### 同类型推荐（**背包家族**）
**完全背包**：
- [LC 322. Coin Change](https://leetcode.cn/problems/coin-change/)（求最少件数，本题）
- [LC 518. Coin Change II](https://leetcode.cn/problems/coin-change-ii/)（求方案数）
- [LC 279. 完全平方数](https://leetcode.cn/problems/perfect-squares/)（拆数 = 完全背包）
- [LC 139. 单词拆分](https://leetcode.cn/problems/word-break/)（字符串完全背包）
