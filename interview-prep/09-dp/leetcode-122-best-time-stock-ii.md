...
### 面试官常见 follow-up
1. **"最多 1 次（[LC 121](https://leetcode.cn/problems/best-time-to-buy-and-sell-stock/)）？"** → 维护历史最低 + 当天差。
2. **"最多 2 次（[LC 123](https://leetcode.cn/problems/best-time-to-buy-and-sell-stock-iii/)）/ 最多 k 次（[LC 188](https://leetcode.cn/problems/best-time-to-buy-and-sell-stock-iv/)）？"** → 状态机 DP `dp[i][j][0/1]`。
3. **"含冷冻期（[LC 309](https://leetcode.cn/problems/best-time-to-buy-and-sell-stock-with-cooldown/)）？"** → 三态：持/不持/冷冻。
4. **"含手续费（[LC 714](https://leetcode.cn/problems/best-time-to-buy-and-sell-stock-with-transaction-fee/)）？"** → 卖出时扣 fee。
5. **"返回每笔具体交易？"** → 贪心时记录每个上涨段的起止。
6. **"流式数据？"** → 贪心 O(1) 摊销。

### 同类型推荐（**股票系列**）
- [LC 121. 买卖股票的最佳时机](https://leetcode.cn/problems/best-time-to-buy-and-sell-stock/)（1 次）
- [LC 122. 本题](https://leetcode.cn/problems/best-time-to-buy-and-sell-stock-ii/)（无限次）
- [LC 123. 最多 2 次](https://leetcode.cn/problems/best-time-to-buy-and-sell-stock-iii/)
- [LC 188. 最多 k 次](https://leetcode.cn/problems/best-time-to-buy-and-sell-stock-iv/)
...
- [LC 901. 股票价格跨度](https://leetcode.cn/problems/online-stock-span/)（单调栈，非交易题）
