...
2. **"LIS 个数（不是长度，[LC 673](https://leetcode.cn/problems/number-of-longest-increasing-subsequence/)）？"** → DP 同时维护 `cnt[i]` 表示以 i 结尾的 LIS 个数。
3. **"二维 LIS（俄罗斯套娃信封）？"** → 宽升高降排序后对高跑 LIS。即 [**LC 354**](https://leetcode.cn/problems/russian-doll-envelopes/)。
...
### 同类型推荐（**LIS 家族**）
- [LC 354. 俄罗斯套娃信封问题](https://leetcode.cn/problems/russian-doll-envelopes/)（二维 LIS）
- [LC 673. 最长递增子序列的个数](https://leetcode.cn/problems/number-of-longest-increasing-subsequence/)（同时维护 cnt）
- LC 1671. 得到山形数组的最少删除次数（双向 LIS）
- [LC 1218. 最长定差子序列](https://leetcode.cn/problems/longest-arithmetic-subsequence-of-given-difference/)（特化为哈希）
- [LC 1143. 最长公共子序列](https://leetcode.cn/problems/longest-common-subsequence/)（DP 入门姊妹题）
- [LC 583. 两个字符串的删除操作](https://leetcode.cn/problems/delete-operation-for-two-strings/)（基于 LCS）
- [LC 72. 编辑距离](https://leetcode.cn/problems/edit-distance/)（LCS 进阶）
